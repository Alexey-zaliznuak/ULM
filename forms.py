...
from models import Place, Studio, Exhibit, Teacher
...
class PlaceForm(UIModelForm):
    class Meta:
        model = Place
        fields = ('id', 'name', 'capacity', 'describe')
...
class ExhibitForm(UIModelForm):
    studio = ForeignKeyField(
        'studio',
        StudioForm,
        datatable_column_title='Владелец'
    )
    class Meta:
        model = Exhibit
