...
PlaceGenerator.generated_objects = [
    {
        'name': 'Музей № 1',
        'category': PlaceCategories.get(name='Просветительское')
    },
    {
        'name': 'Музей № 2',
        'category': PlaceCategories.get(name='Просветительское')
    ...
    {
        'name': 'Татр № 1',
        'category': PlaceCategories.get(name='Развлекательное')
    },
    {
        'name': 'Секция Пения № 1',
        'category': PlaceCategories.get(name='Образовательное')
    },
]
PlaceGenerator.save()
